...
const Password = ({ onValueChange, title, haveAccount, linkHaveAccount, textHaveAccount, forgetPassword, linkForgetPassword, noId }) => {
      ...
      return (
            <div className="flex flex-col mb-5 sm:mb-[37px] text-white">
                  ...
                  <input type="password" name='password' placeholder="Masukan kata sandi" id={`password` + noId} onChange={handleChange} className="py-[7.5px] px-[11.5px] text-[9.2px] sm:py-[14px] sm:px-5 sm:text-base border border-[rgba(231,227,252,0.23)] rounded-full" required />
